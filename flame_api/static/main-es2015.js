...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<p>similarity-results works!</p>\n");
...
/* harmony import */ var _similarity_results_similarity_results_component__WEBPACK_IMPORTED_MODULE_34__ = __webpack_require__(/*! ./similarity-results/similarity-results.component */ "./src/app/similarity-results/similarity-results.component.ts");
/* harmony import */ var _confusion_matrix_confusion_matrix_component__WEBPACK_IMPORTED_MODULE_35__ = __webpack_require__(/*! ./confusion-matrix/confusion-matrix.component */ "./src/app/confusion-matrix/confusion-matrix.component.ts");
/* harmony import */ var angular_datatables__WEBPACK_IMPORTED_MODULE_36__ = __webpack_require__(/*! angular-datatables */ "./node_modules/angular-datatables/index.js");
...
AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
        declarations: [
            ...
            _similarity_results_similarity_results_component__WEBPACK_IMPORTED_MODULE_34__["SimilarityResultsComponent"],
            _confusion_matrix_confusion_matrix_component__WEBPACK_IMPORTED_MODULE_35__["ConfusionMatrixComponent"]
        ],
        imports: [
            ...
            angular_datatables__WEBPACK_IMPORTED_MODULE_36__["DataTablesModule"]
        ],
...
let PredictionListComponent = class PredictionListComponent {
    ...
    selectPrediction(name, modelName, modelVersion) {
...
let PredictionComponent = class PredictionComponent {
    constructor(prediction, service) {
        this.prediction = prediction;
        this.service = service;
        this.objectKeys = Object.keys;
    ...
    saveEXCEL() {
        ...
        /* generate worksheet */
        const ws = xlsx__WEBPACK_IMPORTED_MODULE_7__["utils"].aoa_to_sheet(xls);
    ...
    savePDF() {
        const pdf = new jspdf__WEBPACK_IMPORTED_MODULE_5___default.a();
        pdf.autoTable({
            head: [this.head],
            body: this.info,
            headStyles: {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "SimilarityResultsComponent", function() { return SimilarityResultsComponent; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");


let SimilarityResultsComponent = class SimilarityResultsComponent {
    constructor() { }
    ngOnInit() {
    }
};
SimilarityResultsComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-similarity-results',
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./similarity-results.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/similarity-results/similarity-results.component.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./similarity-results.component.css */ "./src/app/similarity-results/similarity-results.component.css")).default]
    }),
    tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [])
