          ...
          this.service.getSpaces().subscribe(function (result) {
            ...
            try {
              var _loop9 = function _loop9() {
                ...
                _this26.service.getInfo(space.spacename).subscribe(function (result2) {
                  _this26.molsXspace[space.spacename] = result2[0][2];
                }, function (error) {
                  _this26.molsXspace[space.spacename] = 0;
                });
              };
  ...
  function srcAppSimilaritySimilarityServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function () {
      ...
      _createClass(SimilarityService, [{
        ...
        key: "getInfo",
        value: function getInfo(label) {
          var url = _environments_environment__WEBPACK_IMPORTED_MODULE_4__["environment"].baseUrl_smanage + 'space/' + label;
          return this.http.get(url);
        }
      }, {
        key: "search",
